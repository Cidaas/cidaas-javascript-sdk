...
import { DeleteDeviceRequest, GetRegistrationSetupRequest, GetRequestIdOptions, GetUserActivitiesRequest, UpdateProfileImageRequest, UserActionOnEnrollmentRequest } from './webauth.model';
...
describe('Webauth functions without module or services', () => {
	...
	test('getRequestIdWithParameter', () => {
		...
		const payload: GetRequestIdOptions  = {
			'client_id': 'client_id',
